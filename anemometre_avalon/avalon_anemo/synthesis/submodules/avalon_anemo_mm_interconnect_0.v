...
module avalon_anemo_mm_interconnect_0 (
		...
		output wire [1:0]  in_freq_anemo_s1_address,                      //                   in_freq_anemo_s1.address
		input  wire [31:0] in_freq_anemo_s1_readdata,                     //                                   .readdata
	...
	wire  [31:0] in_freq_anemo_s1_agent_m0_readdata;                                        // in_freq_anemo_s1_translator:uav_readdata -> in_freq_anemo_s1_agent:m0_readdata
	wire         in_freq_anemo_s1_agent_m0_waitrequest;                                     // in_freq_anemo_s1_translator:uav_waitrequest -> in_freq_anemo_s1_agent:m0_waitrequest
	wire         in_freq_anemo_s1_agent_m0_debugaccess;                                     // in_freq_anemo_s1_agent:m0_debugaccess -> in_freq_anemo_s1_translator:uav_debugaccess
	wire  [16:0] in_freq_anemo_s1_agent_m0_address;                                         // in_freq_anemo_s1_agent:m0_address -> in_freq_anemo_s1_translator:uav_address
	wire   [3:0] in_freq_anemo_s1_agent_m0_byteenable;                                      // in_freq_anemo_s1_agent:m0_byteenable -> in_freq_anemo_s1_translator:uav_byteenable
	wire         in_freq_anemo_s1_agent_m0_read;                                            // in_freq_anemo_s1_agent:m0_read -> in_freq_anemo_s1_translator:uav_read
	wire         in_freq_anemo_s1_agent_m0_readdatavalid;                                   // in_freq_anemo_s1_translator:uav_readdatavalid -> in_freq_anemo_s1_agent:m0_readdatavalid
	wire         in_freq_anemo_s1_agent_m0_lock;                                            // in_freq_anemo_s1_agent:m0_lock -> in_freq_anemo_s1_translator:uav_lock
	wire  [31:0] in_freq_anemo_s1_agent_m0_writedata;                                       // in_freq_anemo_s1_agent:m0_writedata -> in_freq_anemo_s1_translator:uav_writedata
	wire         in_freq_anemo_s1_agent_m0_write;                                           // in_freq_anemo_s1_agent:m0_write -> in_freq_anemo_s1_translator:uav_write
	wire   [2:0] in_freq_anemo_s1_agent_m0_burstcount;                                      // in_freq_anemo_s1_agent:m0_burstcount -> in_freq_anemo_s1_translator:uav_burstcount
	wire         in_freq_anemo_s1_agent_rf_source_valid;                                    // in_freq_anemo_s1_agent:rf_source_valid -> in_freq_anemo_s1_agent_rsp_fifo:in_valid
	wire  [93:0] in_freq_anemo_s1_agent_rf_source_data;                                     // in_freq_anemo_s1_agent:rf_source_data -> in_freq_anemo_s1_agent_rsp_fifo:in_data
	wire         in_freq_anemo_s1_agent_rf_source_ready;                                    // in_freq_anemo_s1_agent_rsp_fifo:in_ready -> in_freq_anemo_s1_agent:rf_source_ready
	wire         in_freq_anemo_s1_agent_rf_source_startofpacket;                            // in_freq_anemo_s1_agent:rf_source_startofpacket -> in_freq_anemo_s1_agent_rsp_fifo:in_startofpacket
	wire         in_freq_anemo_s1_agent_rf_source_endofpacket;                              // in_freq_anemo_s1_agent:rf_source_endofpacket -> in_freq_anemo_s1_agent_rsp_fifo:in_endofpacket
	wire         in_freq_anemo_s1_agent_rsp_fifo_out_valid;                                 // in_freq_anemo_s1_agent_rsp_fifo:out_valid -> in_freq_anemo_s1_agent:rf_sink_valid
	wire  [93:0] in_freq_anemo_s1_agent_rsp_fifo_out_data;                                  // in_freq_anemo_s1_agent_rsp_fifo:out_data -> in_freq_anemo_s1_agent:rf_sink_data
	wire         in_freq_anemo_s1_agent_rsp_fifo_out_ready;                                 // in_freq_anemo_s1_agent:rf_sink_ready -> in_freq_anemo_s1_agent_rsp_fifo:out_ready
	wire         in_freq_anemo_s1_agent_rsp_fifo_out_startofpacket;                         // in_freq_anemo_s1_agent_rsp_fifo:out_startofpacket -> in_freq_anemo_s1_agent:rf_sink_startofpacket
	wire         in_freq_anemo_s1_agent_rsp_fifo_out_endofpacket;                           // in_freq_anemo_s1_agent_rsp_fifo:out_endofpacket -> in_freq_anemo_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> in_freq_anemo_s1_agent:cp_valid
	wire  [92:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> in_freq_anemo_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // in_freq_anemo_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> in_freq_anemo_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> in_freq_anemo_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> in_freq_anemo_s1_agent:cp_endofpacket
	...
	wire         in_freq_anemo_s1_agent_rp_valid;                                           // in_freq_anemo_s1_agent:rp_valid -> router_008:sink_valid
	wire  [92:0] in_freq_anemo_s1_agent_rp_data;                                            // in_freq_anemo_s1_agent:rp_data -> router_008:sink_data
	wire         in_freq_anemo_s1_agent_rp_ready;                                           // router_008:sink_ready -> in_freq_anemo_s1_agent:rp_ready
	wire         in_freq_anemo_s1_agent_rp_startofpacket;                                   // in_freq_anemo_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         in_freq_anemo_s1_agent_rp_endofpacket;                                     // in_freq_anemo_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         in_freq_anemo_s1_agent_rdata_fifo_src_valid;                               // in_freq_anemo_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] in_freq_anemo_s1_agent_rdata_fifo_src_data;                                // in_freq_anemo_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         in_freq_anemo_s1_agent_rdata_fifo_src_ready;                               // avalon_st_adapter_006:in_0_ready -> in_freq_anemo_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> in_freq_anemo_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> in_freq_anemo_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // in_freq_anemo_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> in_freq_anemo_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) in_freq_anemo_s1_translator (
		.clk                    (clk_0_clk_clk),                           //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset),   //                    reset.reset
		.uav_address            (in_freq_anemo_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (in_freq_anemo_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (in_freq_anemo_s1_agent_m0_read),          //                         .read
		.uav_write              (in_freq_anemo_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (in_freq_anemo_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (in_freq_anemo_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (in_freq_anemo_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (in_freq_anemo_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (in_freq_anemo_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (in_freq_anemo_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (in_freq_anemo_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (in_freq_anemo_s1_address),                //      avalon_anti_slave_0.address
		.av_readdata            (in_freq_anemo_s1_readdata),               //                         .readdata
		.av_write               (),                                        //              (terminated)
		.av_read                (),                                        //              (terminated)
		.av_writedata           (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) in_freq_anemo_s1_agent (
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (in_freq_anemo_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (in_freq_anemo_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (in_freq_anemo_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (in_freq_anemo_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (in_freq_anemo_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (in_freq_anemo_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (in_freq_anemo_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (in_freq_anemo_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (in_freq_anemo_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (in_freq_anemo_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (in_freq_anemo_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (in_freq_anemo_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (in_freq_anemo_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (in_freq_anemo_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (in_freq_anemo_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (in_freq_anemo_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (in_freq_anemo_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (in_freq_anemo_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (in_freq_anemo_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (in_freq_anemo_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (in_freq_anemo_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (in_freq_anemo_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (in_freq_anemo_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (in_freq_anemo_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (in_freq_anemo_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (in_freq_anemo_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (in_freq_anemo_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (in_freq_anemo_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (in_freq_anemo_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) in_freq_anemo_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                     //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_data           (in_freq_anemo_s1_agent_rf_source_data),             //        in.data
		.in_valid          (in_freq_anemo_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (in_freq_anemo_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (in_freq_anemo_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (in_freq_anemo_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (in_freq_anemo_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (in_freq_anemo_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (in_freq_anemo_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (in_freq_anemo_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (in_freq_anemo_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	avalon_anemo_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (in_freq_anemo_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (in_freq_anemo_s1_agent_rp_valid),         //          .valid
		.sink_data          (in_freq_anemo_s1_agent_rp_data),          //          .data
		.sink_startofpacket (in_freq_anemo_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (in_freq_anemo_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	avalon_anemo_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                               // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),       // in_rst_0.reset
		.in_0_data      (in_freq_anemo_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (in_freq_anemo_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (in_freq_anemo_s1_agent_rdata_fifo_src_ready), //         .ready
